...
<h1 class="display-3">Editar Trabajo</h1>
...
<form method="POST" action="{{url("AdminPanel/Trabajos/{$work->id}")}}" class="needs-validation" enctype="multipart/form-data">
	{!! csrf_field() !!}
	 {{method_field('PUT')}}
  <div class="row mt-4">
  <div class="col-md-4">
		...
		<div class="col-md-3">
			<div class="form-group">
				<label for="formGroupExampleInput">Icono</label> <input type="file"
					class="form-control-file" name="icon_work" />
			</div>
		</div>
	</div>
