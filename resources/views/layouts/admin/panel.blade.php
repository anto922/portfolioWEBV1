				...
				<div class="sidebar-sticky">
					...
					<div class="collapse" id="collapseExample4">
						<ul class="nav flex-column">
							...
							<li class="nav-item bg-dark"><a class="nav-link  pl-4 text-white" href="{{url('/AdminPanel/Estudios')}}"> <span class="oi oi-plus"></span>
									Ver Formación
							</a></li>
					...
					<div class="collapse" id="collapseExample5">
						<ul class="nav flex-column">
							...
							<li class="nav-item bg-dark"><a class="nav-link  pl-4 text-white" href="{{url('/AdminPanel/Trabajos')}}"> <span class="oi oi-plus"></span>
									Ver Trabajos
							</a></li>
